...
class Delsin:
    ...
    def listar_materiais(self):
        ...
        #if aq
        print(" - Organizadores laterais: ", self.sala_telecom['tomadas'])
        print(" - Rack: ", self.sala_telecom['tomadas'])
        print("\tTamanho: ", self.sala_telecom['pts_voz'], "U")
        print("\tQuantidade: ", self.sala_telecom['pts_voz'])
